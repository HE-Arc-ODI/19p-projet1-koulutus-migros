...
public class ProgramResource {
    ...
    public void registerParticipantToCourse(@PathParam("programId") Long programId,
        ...
        try {
            Course course = persistenceService.getCourseById(programId, courseId);
            if (course.getMaxNumberOfParticipants() == course.getParticipants().size()) {
                throw new CourseException("not possible to add more participant ");
            }
